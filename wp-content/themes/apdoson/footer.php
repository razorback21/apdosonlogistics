    ...
    <div class="container mx-auto px-4">
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li class="flex items-start">
                ...
                <span class="text-gray-600">OFFICE : <br/><?= get_option('office_address') ?></span>
              </li>
              <li class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-14 h-5 text-logistics-blue mt-0.5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                ...
                <span class="text-gray-600">SERVICE WAREHOUSE :<br/> <?= get_option('warehouse_address') ?></span>
              </li>
              <li class="flex items-start">
              ...
              <li class="flex items-start">
                ...
                <a href="mailto:<?= get_option('email'); ?>" class="text-gray-600 mb-2 hover:text-logistics-blue"><?= get_option('email'); ?></a>
              </li>
              <li class="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-logistics-blue mt-0.5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="py-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-600 text-sm mb-4 md:mb-0">
          © <?= date('Y'); ?> Apdoson Logistics. All rights reserved. Website built by <a href="https://donnygapulao.site" target="_blank" class="text-logistics-blue hover:text-logistics-blue/80">Donny Gapulao</a>.
        </p>
